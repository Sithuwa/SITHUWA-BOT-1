...
let SewQueen = require('sithuwa-bit-pro/sources/dc/handler');
let Details = require('sithuwa-bot-pro/sources/dc/Details');
let {sendMessagecalculate} = require('sithuwa-bot-pro/sources/dc/cmd/cal')
let { MessageType, MessageOptions, Mimetype, GroupSettingChange, ChatModification } = require('https://github.com/Sithuwa/SITHUWA-BOT-1');
let fs = require('fs');
let os = require('os');
